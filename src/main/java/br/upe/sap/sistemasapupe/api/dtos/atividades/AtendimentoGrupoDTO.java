...
public record AtendimentoGrupoDTO (UUID id, UUID sala, LocalDateTime tempoInicio,
    ...
    public static AtendimentoGrupo from(AtendimentoGrupoDTO atendimentoGrupoDTO, Sala sala,
    ...
    public static AtendimentoGrupoDTO to(AtendimentoGrupo atendimentoGrupo, UUID idGrupoTerapeutico){
